#!/usr/bin/env python
"""Provide command line interface to risk_cohort_rnaseq."""
...
import risk_cohort_rnaseq.cli.config as _config
from risk_cohort_rnaseq.misc import process_config, update_configs
